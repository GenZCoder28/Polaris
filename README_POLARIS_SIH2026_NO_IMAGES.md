...
The README intentionally contains **no embedded images for now**. The following are the exact prototype screenshots that should be uploaded later.

## 1. Expedition Planning & Management

**Image to upload:** `expedition-management.png`

**Capture:** The main POLARIS Expedition Planning & Management screen showing the expedition summary cards and Recent Expeditions Registry.
...
**Recommended screenshot:** The full dashboard screen you already captured.
...
**Capture:** The **Register New Antarctic Expedition** form.
...
**Recommended screenshot:** The complete registration modal with the step navigation visible.

---

## 3. Polar Navigation & Fast-Ice Moorings

**Image to upload:** `polar-navigation.png`

**Capture:** The Polar Navigation & Fast-Ice Moorings screen.
...
- Fast-ice mooring information
- Operational map
- Vessel/station markers

**Recommended screenshot:** The screen you already captured with the vessel cards above the map.
...
**Capture:** The main Polar Emergency & Safety Management dashboard.
...
**Recommended screenshot:** Use the complete dashboard view rather than only the popup.

---

## 5. Manual Emergency Reporting

**Image to upload:** `emergency-report-dialog.png`

**Capture:** The **Report Station Emergency** dialog.
...
**Recommended screenshot:** The complete dialog with the surrounding emergency page slightly visible.
...
### When You Are Ready to Add the Images

Replace each upload instruction with the normal Markdown image syntax:
...
**Use only screenshots from the actual POLARIS prototype. Do not use generic or stock images.**
